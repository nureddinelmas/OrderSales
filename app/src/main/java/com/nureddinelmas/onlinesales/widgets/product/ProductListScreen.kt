...
import com.nureddinelmas.onlinesales.print.createAndShareAllProductsList
				...
				Card(
					...
					Column(
						...
						Row {
							...
							IconButton (onClick = {
								createAndShareAllProductsList(context = context, productViewModel = productViewModel)
							}){
								Icon(
